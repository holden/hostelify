...
Gem::Specification.new do |s|
  ...
  s.files = ["Manifest", "README.rdoc", "Rakefile", "hostelify.gemspec", "lib/hostelify.rb", "lib/hostelify/gomio.rb", "lib/hostelify/hostelbookers.rb", "lib/hostelify/hostelify.rb", "lib/hostelify/hostelworldmonkey.rb", "pkg/hostelify-0.2.4.gem", "pkg/hostelify-0.2.4.tar.gz", "pkg/hostelify-0.2.4/Manifest", "pkg/hostelify-0.2.4/README.rdoc", "pkg/hostelify-0.2.4/Rakefile", "pkg/hostelify-0.2.4/hostelify.gemspec", "pkg/hostelify-0.2.4/lib/hostelify.rb", "pkg/hostelify-0.2.4/lib/hostelify/gomio.rb", "pkg/hostelify-0.2.4/lib/hostelify/hostel.rb", "pkg/hostelify-0.2.4/lib/hostelify/hostelbookers.rb", "pkg/hostelify-0.2.4/lib/hostelify/hostelworld.rb", "pkg/hostelify-0.2.4/spec/_helper.rb", "pkg/hostelify-0.2.4/spec/hb_find_by_hostel.spec", "pkg/hostelify-0.2.4/spec/hb_find_hostels.spec", "pkg/hostelify-0.2.4/spec/hw_find_by_hostel.spec", "pkg/hostelify-0.2.4/spec/hw_find_hostels.spec", "spec/_helper.rb", "spec/hb_find_by_hostel.spec", "spec/hb_find_hostels.spec", "spec/hw_find_by_hostel.spec", "spec/hw_find_hostels.spec"]
  s.has_rdoc = true
